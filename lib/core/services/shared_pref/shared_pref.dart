...
class SharedPref {
  ...
  ///Bellow method is to set the String value in the SharedPreferences.
  Future<dynamic> setString(String key, String stringValue) async {
    await sharedPreferences.setString(key, stringValue);
  }

  ///Bellow method is to get the stringValue from the SharedPreferences.
  ...
  ///Bellow method is to get the booleanValue from the SharedPreferences.
